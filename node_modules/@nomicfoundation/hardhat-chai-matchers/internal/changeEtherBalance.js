...
function supportChangeEtherBalance(Assertion) {
    Assertion.addMethod("changeEtherBalance", function (account, balanceChange, options) {
        ...
        const derivedPromise = Promise.all([
            ...
            this.assert(actualChange.eq(BigNumber.from(balanceChange)), `Expected the ether balance of "${address}" to change by ${balanceChange.toString()} wei, but it changed by ${actualChange.toString()} wei`, `Expected the ether balance of "${address}" NOT to change by ${balanceChange.toString()} wei, but it did`, balanceChange, actualChange);
        });
