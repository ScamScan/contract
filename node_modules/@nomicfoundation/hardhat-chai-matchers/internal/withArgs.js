...
function supportWithArgs(Assertion, utils) {
    Assertion.addMethod("withArgs", function (...expectedArgs) {
        ...
        const derivedPromise = promise.then(() => {
            if (emitCalled) {
                return (0, emit_1.emitWithArgs)(this, Assertion, utils, expectedArgs);
            }
            else {
                return (0, revertedWithCustomError_1.revertedWithCustomErrorWithArgs)(this, Assertion, utils, expectedArgs);
            }
        });
